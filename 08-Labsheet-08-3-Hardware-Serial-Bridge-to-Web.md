...
2. กด Refresh (F5) บนหน้าเบราว์เซอร์หลายๆ ครั้งติดต่อกัน สังเกตว่า:
   ...
   - **คำตอบ:** dataSource เปลี่ยนเป็น Simulation Mode (Sine Wave) และค่า rawValue ยังเปลี่ยนได้ โดยค่าจะเพิ่มและลดขึ้นลงต่อเนื่องเป็นลักษณะคลื่นไซน์ เพื่อจำลองค่าจากเซนเซอร์
---
...
<img width="2940" height="1912" alt="image" src="https://github.com/user-attachments/assets/e861d294-7eb1-47df-b3b8-fde7d964b4ea" />
